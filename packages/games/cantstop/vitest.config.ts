...
/**
 * Can't Stop is the Track D pilot **retrofit** (phase 2): the first of the four legacy games moved out
 * of the shared `engine/` + `bot/` packages into its own in-workspace game package, following the RR
 * precedent. This config carries **both** coverage gates the game used to answer to — the platform-wide
