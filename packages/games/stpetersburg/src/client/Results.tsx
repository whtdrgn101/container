      ...
      <table className="w-full text-sm" data-testid="sp-results">
        <thead>
          <tr className="text-left text-xs text-muted-foreground">
            ...
            <th className="px-1 font-medium" title="Points already banked on the score track">
              Base
            </th>
            <th className="px-1 font-medium" title="Distinct aristocrats, scored by the board table">
              Aristocrats
            </th>
            <th className="px-1 font-medium" title="1 point per full 10 rubles">
              Money
            </th>
            <th className="px-1 font-medium" title="−5 per card still in hand">
              Hand
            </th>
          ...
          {[...game.results]
            ...
            .map((r) => {
              ...
              return (
                <tr
                  key={r.playerId}
                  data-testid={`sp-result-${r.playerId}`}
                ...
                >
                  ...
                  <td className="px-1 tabular-nums text-muted-foreground">
                    {r.handPenalty > 0 ? `−${r.handPenalty}` : '0'}
                  </td>
