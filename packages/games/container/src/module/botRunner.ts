import { bidFor, chooseTiedWinner, contextFor, decide, runoffBidFor, wantsBuyout } from '../bot';
 ...
 *
 * The runner has no special powers. It builds actions with the same `@game-hub/game-container/bot` policies used
