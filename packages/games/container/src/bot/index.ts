/**
 * `@game-hub/game-container/bot` — AI players for Container. THE public API; consumers import only from here.
 *
 * The split from `@game-hub/game-container/engine` is deliberate: the **engine owns the rules** (what is legal),
