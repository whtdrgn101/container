...
import { advanceTrack, canAdvance, legalSteps, nextActiveSeat, record, seatOf, withPlayer } from '../internal';
...
export function moveTrack(
  ...
  return record(
    ...
    'MOVE_TRACK',
    playerId,
    { players, pendingMoves: null, activePlayerIndex: nextActiveSeat(state)! },
