...
/**
 * The `GameModule` seam, bound for Stone Age (Track D — legacy-migration phase 3).
 *
 ...
 * `backend/src/games/module.ts`), so this binding and the host stay in lockstep. Stone Age opens no
