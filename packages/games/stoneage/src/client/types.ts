...
/**
 * The `GameClient` seam, bound for Stone Age (Track D — legacy-migration phase 3).
 *
 ...
 * binding `ui/src/games/types.ts` makes for the in-repo games, and the RR/Can't Stop precedent's
