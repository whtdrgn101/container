...
// genuinely cross-game lives here: the error type, the move-record/viewer shapes, and — once a third
// game proved them identical (REVIEW.md §3.2) — the `record()` version/log mechanism and the seat
// helpers. Extract on the third example, not the first; resist the coincidental (see `viewFor`).
