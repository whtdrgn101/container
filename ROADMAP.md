...
| **Stone Age** | in progress: bootstrap (SA0), placement (SA1), resource gathering + dice engine (SA2) shipped; more per-place actions next | [`engine/src/games/stoneage/ROADMAP.md`](engine/src/games/stoneage/ROADMAP.md) |
